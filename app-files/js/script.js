function insertarRestoDelFormulario(tipo) {
	var contenedor = $("#parteExpansible");
	...
	switch(tipo){
		case 1:
			...
			contenedor.html(' \
				<div class="form-group row"> \
					<label for="cargo_empleado" class="col-xs-2 col-form-label">Cargo inicial del empleado</label> \
					<div class="col-xs-10"> \
		...
		case 2:
			...
			contenedor.html(' \
				<div class="form-group row"> \
					<label for="rif" class="col-xs-2 col-form-label">RIF</label> \
					<div class="col-xs-10"> \
				 ...
				 \
				<div class="form-group row"> \
					<label for="numColegio" class="col-xs-2 col-form-label">Número de Colegio de Odontólogos</label> \
					<div class="col-xs-10"> \
...
function agregarCamposSeleccionEspecializaciones() {
	...
	for (var i = 0; i < cantidad_especializaciones; i++) {
		divEspecializaciones.append(' \
				<div class="form-group row"> \
					<label for="especializacion-' + i + '" class="col-xs-2 col-form-label">Cantidad de especializaciones</label> \
