...
function draw(tipo = 0, data = null){
	...
	for(var key in data) {
		values.push(data[key].CANTIDAD);
		labels.push(data[key].IMPLEMENTO);
		background.push('rgba('+Math.floor((Math.random() * 255) + 1)+
		', '+Math.floor((Math.random() * 255) + 1)+
		', '+Math.floor((Math.random() * 255) + 1)+
		', '+Math.random()+')');

		border.push('rgba('+Math.floor((Math.random() * 255) + 1)+
		', '+Math.floor((Math.random() * 255) + 1)+
		', '+Math.floor((Math.random() * 255) + 1)+
		', '+Math.random()+')');
	}
