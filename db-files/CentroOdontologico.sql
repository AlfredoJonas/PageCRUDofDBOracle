...
ALTER TABLE TRATAMIENTO ADD CONSTRAINT TRATAMIENTO_FK1 FOREIGN KEY ( ID_ESPECIALIZACION ) 
REFERENCES ESPECIALIZACION ( ID ) ON DELETE CASCADE NOT DEFERRABLE ;
...
INSERT INTO TRATAMIENTO_IMPLEMENTO VALUES(1,1,2,0,1);
...
BEGIN
    ...
    SELECT NVL((SELECT COUNT(*) FROM CITA_TRATAMIENTO CIT GROUP BY CIT.CI_MEDICO, TO_CHAR(CIT.FECHA,'DD/MM/YY:HH') 
    HAVING CIT.CI_MEDICO = :NEW.CI_MEDICO AND TO_CHAR(CIT.FECHA,'DD/MM/YY:HH') = TO_CHAR(:NEW.FECHA,'DD/MM/YY:HH') ),0) INTO NUM_CITAS FROM DUAL;
