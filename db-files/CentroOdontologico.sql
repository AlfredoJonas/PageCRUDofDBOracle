...
CREATE OR REPLACE 
TRIGGER CITAS_AL_DIAHORA_POR_MEDICO
...
BEGIN
    ...
    IF NUM_CITAS >= 8 THEN
      RAISE_APPLICATION_ERROR(-20505, 'NO SE PUEDEN ASIGNAR MAS DE 8 CITAS AL DIA POR MEDICO: '||NUM_CITAS);
    END IF;
    ...
    IF NUM_CITAS >= 3 THEN
       RAISE_APPLICATION_ERROR(-20505, 'NO SE PUEDEN ASIGNAR MAS DE 3 CITAS POR HORA POR MEDICO: '||NUM_CITAS);
    END IF;
